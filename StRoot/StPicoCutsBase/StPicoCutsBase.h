...
class StPicoCutsBase : public TNamed
{
 public:
  ...
  bool cutMaxDcaToPrimVertex(StPicoTrack const * const trk, int pidFlag) const;   //Feng Liu 2025/12/24
...
private:
  ...
  float mDcaMax[kPicoPIDMax];      //Feng Liu 2025/12/24
...
inline void StPicoCutsBase::setCutDcaMax(float max, int pidFlag)                        { mDcaMax[pidFlag] = max; } //Feng Liu 2025/12/25
